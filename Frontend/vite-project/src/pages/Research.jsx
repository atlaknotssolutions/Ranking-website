    ...
    <main className="mx-auto max-w-6xl px-4 pb-20 pt-32 sm:px-6 lg:px-8">
      <div className="rounded-[2rem] bg-white p-8 shadow-sm sm:p-12">
        ...
        <p className="mt-4 max-w-3xl text-lg leading-8 text-[#4d5665]">
          Goethe University Frankfurt drives innovation across the sciences,
          humanities, medicine, and social research to address global challenges
          in sustainability, health, culture, and technology.
        </p>
        <div className="mt-8 grid gap-6 md:grid-cols-3">
          {[
            ...
            <div
              key={item}
              className="rounded-2xl bg-[#f5f1ea] p-5 text-[#1a1a1a]"
            >
