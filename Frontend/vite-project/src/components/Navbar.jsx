          ...
          <div className="flex h-[72px] items-center justify-between">
            <div className="flex items-center gap-8">
              ...
              <nav className="hidden items-center gap-7 text-[15px] font-medium md:flex">
                <a href="#" className="transition hover:text-[#1a3a6e]">University</a>
                <a href="#" className="transition hover:text-[#1a3a6e]">Research</a>
                <a href="#" className="transition hover:text-[#1a3a6e]">Study and Teaching</a>
                <a href="#" className="transition hover:text-[#1a3a6e]">Knowledge Transfer</a>
                <a href="#" className="transition hover:text-[#1a3a6e]">International</a>
              </nav>
            </div>
